...
variable "enabled" {
  type = bool
  default = "true"
  description = "Enabled must be true for these objects and policies to write to AWS"
}

variable "domain_name" {
  type = string
  default = ""
  description = "This is the domain name of the website we're deploying"
}

# More variables can be scraped from the following URL:
# https://github.com/cloudposse/terraform-aws-s3-bucket/blob/main/examples/complete/variables.tf
